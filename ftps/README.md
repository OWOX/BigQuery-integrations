...
- доступ на редактирование (роль *Редактор данных BigQuery*) для сервисного аккаунта Cloud-функции в проекте BigQuery, куда будет загружена таблица (см. раздел [Доступы](https://github.com/OWOX/BigQuery-integrations/tree/master/ftps#Доступы));
...
Получите имя пользователя и пароль на FTPS - сервере, где расположен файл с правами на чтение. 
